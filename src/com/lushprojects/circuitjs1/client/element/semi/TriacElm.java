...
import com.lushprojects.circuitjs1.client.element.Diode;
...
public class TriacElm extends CircuitElm {
	...
	int gatelen = sim.gui.gridSize;
	gatelen += leadlen % sim.gui.gridSize;
	if (leadlen < gatelen) {
	    x2 = x; y2 = y;
	    return;
	}
	interpPoint(lead2, point2, gate[0], gatelen/leadlen, gatelen*dir);
	interpPoint(lead2, point2, gate[1], gatelen/leadlen, sim.gui.gridSize*2*dir);
    }
