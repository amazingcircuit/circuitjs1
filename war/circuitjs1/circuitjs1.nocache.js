...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "circuitjs1" because\n';
  ...
  $wnd.__gwt_activeModules['circuitjs1'] = {
    'moduleName' : 'circuitjs1',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/circuitjs1.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['circuitjs1'].superdevmode = true;

  var expectedSuffix = '/circuitjs1.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + circuitjs1 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:circuitjs1';
  var devModeSessionKey = '__gwtDevModeSession:circuitjs1';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/circuitjs1/circuitjs1.nocache.js';
  ...
  $wnd.__gwt_activeModules['circuitjs1'].canRedirect = true;
  $wnd.__gwt_activeModules['circuitjs1'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/circuitjs1?user.agent=' + ua + '&_callback=' + callback;
